...
import com.example.lab23.MainActivity;
...
public class BackgroundTask_POST extends AsyncTask<Void,Void,Void> {
    ...
    public BackgroundTask_POST(Context context, String stW, TextView tvResult) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String param = "canh=" + URLEncoder.encode(stW,"utf-8");
